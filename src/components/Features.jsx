  ...
  const Features = () => {
    ...
    return (
    <section className="px-2 mx-4 text-center md:px-4 md:px-14 md:mx-14 font-Montserrat my-14 md:text-left">
      <div className="flex flex-col items-center justify-center md:flex-row md:justify-between">
        <div className="mb-4 md:mb-0">
          <div className="flex items-center">
            ...
            <img src={arrow2} alt="arrow_icon" className="hidden ml-8 md:inline-block" />
          </div>
        </div>
        <div>
          <div className="">
