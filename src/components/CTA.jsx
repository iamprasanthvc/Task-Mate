    ...
    return (
      <section className='hidden bg-white px-14 cta-box mx-14 font-Montserrat md:block'>
            <div className="flex items-center justify-between w-full py-10 navbar">
                    ...
                    <img src={location} alt="location_icon" className="w-[75px] h-[50px]"></img>
                ...
                <div>
                 ...
                 <div>
                    <img src={phone} alt="phone_icon" className="w-[75px] h-[50px]"></img>
                </div> 
                <div>
                 ...
                 <div>
                    <img src={mail} alt="Mail_icon" className="w-[75px] h-[50px]"></img>
                </div> 
                <div>
