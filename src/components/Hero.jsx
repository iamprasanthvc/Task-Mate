...
import { arrow, heroImage, mobilehero, heroo } from "../Assets";
import CTA from "./CTA";
...
const Hero = () => {
  ...
  <img src={arrow} alt="arrow" className="w-[40px] h-[100%] md:block hidden ml-10" />
</div>
  ...
  <img src={heroo} alt="heroimage" className="w-[100%] h-[100%] relative z-[5] md:block hidden" />
  <img src={mobilehero} alt="Mobilehero" className="block md:hidden w-[75%] h-[100%] relative z-[5]" />
        {/* gradient start */}
